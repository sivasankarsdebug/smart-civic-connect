  ...
  return (
    <main className="submit-page">
      <div className="page-head">
        ...
        <p className="page-sub">Enter your Complaint ID to check its current status.</p>
      </div>
      ...
      <div className="track-stack">
        ...
        {complaint && (
          <div className="preview-card">
            <img src={complaint.imageUrl} alt="Complaint" className="preview-image" />

            <div className="preview-row">
              <span className="preview-row-label">Complaint ID</span>
              <span className="preview-row-value">{complaint.complaintId}</span>
            </div>
            <div className="preview-row">
            ...
            <div className="preview-row">
              ...
              <span className="preview-row-value">{complaint.department}</span>
            </div>

            <div className="preview-block">
              <span className="preview-row-label">Description</span>
              <p className="preview-description">{complaint.description}</p>
            </div>

            <div className="preview-row">
              <span className="preview-row-label">Latitude</span>
              <span className="preview-row-value">{complaint.lat?.toFixed(6)}</span>
            </div>
            <div className="preview-row">
              <span className="preview-row-label">Longitude</span>
              <span className="preview-row-value">{complaint.lng?.toFixed(6)}</span>
            </div>
            <div className="preview-row">
              <span className="preview-row-label">Submitted</span>
              <span className="preview-row-value">{formatTimestamp(complaint.createdAt)}</span>
            </div>
          </div>
        )}
      </div>
